  ...
  return (
    <div className='w-100 rating'>
        <div className='row size '>
            ...
            <div className='col-lg-3 col-md-6'>
                <div className='text-center box rounded py-4 px-4 text-light'>
                    <h2 className='title' > <a className=' title fs-2 text-decoration-none'  href='https://www.dextools.io/app/en/bnb/pair-explorer/0x7bb9cEC01cfAde5AD7681E21462fF596B8Fae47f?utm_source=telegram&utm_medium=bubblebuybot&utm_campaign=bubblebuybot' >Check</a>  </h2>
